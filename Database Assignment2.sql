...
(
 ...
 INSERT INTO TITLES VALUES (1004,'JAVA COMP. REF',3,'JAVA','3-04-04','P',499);
 INSERT INTO TITLES VALUES (1005,'PRO. VB.NET',2,'VB','15-05-05','P',450);
...
select * from titles where pubdate <'12-04-03';
select sname from subjects where subid='java'or subid='jee'; 
select aname from authors where auid <300;
